...
import be.ucll.campus.error.ReservationCannotBeInPastException;
import be.ucll.campus.error.ReservationStartMustBeBeforeEndException;
import be.ucll.campus.error.RoomAlreadyInReservationException;
import be.ucll.campus.error.RoomNotAvailableException;
